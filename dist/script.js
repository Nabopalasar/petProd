...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (checkLangInputs);
...
const showMoreStyles = (trigger, wrapper) => {
  ...
  btn.addEventListener('click', function () {
    (0,_services_requests__WEBPACK_IMPORTED_MODULE_0__.getResource)('http://localhost:3004/styles').then(res => createCards(res)).catch(error => console.log(error));
    this.remove();
  });
...
/* harmony import */ var _modules_checkLangInputs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/checkLangInputs */ "./src/js/modules/checkLangInputs.js");
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_checkLangInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="name"]');
  (0,_modules_checkLangInputs__WEBPACK_IMPORTED_MODULE_4__["default"])('[name="message"]');
